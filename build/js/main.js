!function(){function e(e){return e[function(e){return Math.floor(Math.random()*e.length)}(e)]}function r(e){return asciis[e]||null}function n(e){return asciis.find(r=>r.name===e)||null}function a(e,r={}){const n=["font-family: monospace;","white-space: pre;"];return!1!==r.color&&n.unshift(`color: ${r.color||e.color};`),n.join(" ")}function o(e,r={}){r.credits&&console.log(`ASCII by ${e.author||"Unknown"}`)}function i(e,r={}){const i=n(e);i?(console.log(`%c${i.art}`,a(i,r)),o(i,r)):console.warn(`ASCII not found for name: ${e}`)}globalThis.AsciiPrinter={version:"1.1.0",get catalog(){return asciis},getById:r,getByName:n,listTypes:function(){return[...new Set(asciis.map(e=>e.type))]},listNames:function(e="all"){return("all"===e?asciis:asciis.filter(r=>r.type===e)).map(e=>e.name)},list:function(e="all"){return asciis.map((e,r)=>({id:r,name:e.name,category:e.type})).filter(r=>"all"===e||r.category===e)},printById:function(e,n={}){const i=r(e);i?(console.log(`%c${i.art}`,a(i,n)),o(i,n)):console.warn(`ASCII not found for id: ${e}`)},printByName:i,printBySearch:function(e,r={}){const n=e.toLowerCase(),a=asciis.find(e=>e.name.toLowerCase().includes(n));a?i(a.name,r):console.warn(`ASCII not found for search: ${e}`)},printRandom:function(r="all",n={}){var a=asciis.filter(e=>e.type===r);a.length<1&&(a=Object.values(asciis)),i(e(a).name,n)},printRandomFrom:function(r,a={}){if(!Array.isArray(r)||r.length<1)return void console.warn("ASCII names must be a non-empty array.");const o=r.map(e=>n(e)).filter(Boolean);if(o.length<1)return void console.warn("No ASCII found for the provided names.");i(e(o).name,a)}}}();var asciis=[{type:"animal",name:"anteater",art:String.raw`
       _.---._    /\\
    ./'       "--'\//
  ./              o \
 /./\  )______   \__ \
